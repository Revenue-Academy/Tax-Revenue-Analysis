...
twoway (line Tax_Capacity_excises  year if Country_Code=="`v'" & year>=1995) (connected excises  year if Country_Code=="`v'" & year>=1995), legend(lab(1 "Tax Capacity Excise Tax") lab(2 "Excise Tax")) ytitle("% of GDP") title("`w': Tax Capacity and Performance Excise Tax, size(medium)") xlabel(1995 2000 2005 2010 2014 2018)
...
egen max_inc = max(inc) if year==2018, by(ln_GDP_PC_bin)
replace max_inc = max_inc+2
sort ln_GDP_PC
twoway (scatter inc ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' Income Taxes")) (scatter inc ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_inc ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit inc ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
...
*gen ln_GDP_PC_bin = trunc(ln_GDP_PC*10)
egen max_indv = max(indv) if year==2018, by(ln_GDP_PC_bin)
replace max_indv = max_indv+2
sort ln_GDP_PC
twoway (scatter indv ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' PIT")) (scatter indv ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_indv ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit indv ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
...
*gen ln_GDP_PC_bin = trunc(ln_GDP_PC*10)
egen max_corp = max(corp) if year==2018, by(ln_GDP_PC_bin)
replace max_corp = max_corp+2
sort ln_GDP_PC
twoway (scatter corp ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' CIT")) (scatter corp ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_corp ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit corp ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
...
*gen ln_GDP_PC_bin = trunc(ln_GDP_PC*10)
egen max_vat = max(vat) if year==2018, by(ln_GDP_PC_bin)
replace max_vat = max_vat+2
sort ln_GDP_PC
twoway (scatter vat ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' VAT")) (scatter vat ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_vat ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit vat ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
...
*gen ln_GDP_PC_bin = trunc(ln_GDP_PC*10)
egen max_goods = max(goods) if year==2018, by(ln_GDP_PC_bin)
replace max_goods = max_goods+2
sort ln_GDP_PC
twoway (scatter goods ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' Taxes on Goods and Services", size(medium))) (scatter goods ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_goods ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit goods ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
...
*gen ln_GDP_PC_bin = trunc(ln_GDP_PC*10)
egen max_excises= max(excises) if year==2018, by(ln_GDP_PC_bin)
replace max_excises = max_excises+2
sort ln_GDP_PC
twoway (scatter excises ln_GDP_PC if year == 2018, mlabel (Country_Code) msize(small) title("`w' Excise Tax")) (scatter excises ln_GDP_PC if Country_Code=="`v'" & year == 2018, mlabel (Country_Code) mlabcolor(black) msize(small) mcolor(red)) (lowess max_excises ln_GDP_PC if year == 2018, lpattern(dash) lwidth(thin) lcolor(black) msymbol(i)) (lfit excises ln_GDP_PC if year==2018, lcolor(black) lwidth(thin)), legend(off) ytitle("(% of GDP)")
